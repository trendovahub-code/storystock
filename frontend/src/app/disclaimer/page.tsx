...
export const metadata: Metadata = {
    title: "Disclaimer - Trendova Hub",
    description: "Trendova Hub is an educational analysis tool and does not provide investment advice.",
}

export default function DisclaimerPage() {
    return (
        <div className="max-w-4xl mx-auto px-4 py-16">
            <h1 className="text-4xl font-bold text-slate-900 mb-8">Trendova Hub Disclaimer</h1>
            <div className="p-8 bg-slate-50 border border-slate-200 rounded-2xl">
                <p className="text-lg text-slate-700 leading-relaxed font-medium mb-6">
                    DISCLAIMER: Trendova Hub is an educational analysis tool, not investment advice.
